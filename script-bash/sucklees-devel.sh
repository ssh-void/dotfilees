...
# nsxiv
doas xbps-install -Syu imlib2-devel # libImlib2
doas xbps-install -Syu imlib2-devel libXinerama-devel libXft-devel
doas xbps-install -Syu inotify-tools-devel
doas xbps-install -Syu libexif-devel
